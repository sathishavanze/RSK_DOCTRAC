...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
        ...
        group           : 0,
        maxDepth        : 2,//maxDepth 2 to fix the child list
        threshold       : 20,
        allowDecrease   : true,
        allowIncrease   : true
    };
    ...
    Plugin.prototype = {
        ...
        dragStart: function(e)
        {
            ...
            this.dragLevel = dragItem.parents(this.options.listNodeName).length;console.log(this.dragLevel);
        ...
        dragStop: function(e)
        {
            ...
            this.reset();
            var checklist=$('#nestable-output').val();
            $.ajax({
              type:'POST',
              data:{'data':checklist},
              url: base_url + "Documenttype/documentChecklistPosition1",
