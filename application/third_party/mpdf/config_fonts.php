...
*/
		...
		$this->fontdata = array(
			"courier_new" => 
			array (
				'R' => 'CourierNewPSMT.ttf',
				'B' => 'CourierNewPSMT.ttf',
				),
...
// Always include "sans-serif", "serif" and "monospace" etc.
		$this->sans_fonts = array('calibri','dejavusanscondensed','dejavusans','freesans','liberationsans','sans','sans-serif','cursive','fantasy', 
