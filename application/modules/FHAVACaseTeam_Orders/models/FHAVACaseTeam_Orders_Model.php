...
class FHAVACaseTeam_Orders_Model extends MY_Model {
	...
	function total_count()
	{
		...
		/*^^^^^ Get MyOrders Query ^^^^^*/
		$this->Common_Model->GetFHAVACaseTeamQueue(false);
  ...
  // New Orders
	function count_all($post=[])
	{
		...
		$this->Common_Model->GetFHAVACaseTeamQueue();
	...
	function FHAVACaseTeamOrders($post,$module,$global='') {
		$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
  ...
  // Work in Progress
	...
	function KickBackFHAVACaseTeamOrders($post,$module,$global='') {
		$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
		$this->db->select('tOrderImport.*, tOrderPropertyRole.*, mUsers.UserName AS AssignedUserName, tOrderAssignments.AssignedDatetime');
	...
	function Expiredcount_all($post=[])
	{
		...
		/*^^^^^ Get New Orders Query ^^^^^*/
		$this->Common_Model->GetFHAVACaseTeamQueue(false,['filtercompletedorders'=>true]);
