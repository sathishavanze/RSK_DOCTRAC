	...
	<div class="card-body">
		...
		<form action="#"  name="user_form" id="user_form">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group bmd-form-group">
						<label for="password" class="bmd-label-floating">Password<span class="mandatory"></span></label>
				...
				<div class="col-md-3">
					<div class="form-group bmd-form-group">
						...
						<input type="text" class="form-control" id="contactno" name="contactno" data-mask="(000)000-0000" maxlength="13"/>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group bmd-form-group">
						...
						<input type="text" class="form-control" id="faxno" name="faxno" data-mask="(000)000-0000" maxlength="13"/>
					</div>
				</div>
				...
				<?php if(in_array($this->RoleType, $this->config->item('Super Admin'))) { ?>
					<div class="col-md-3">
						<div class="form-group bmd-form-group">
							<label for="CustomerUID" class="bmd-label-floating">Client</span></label>
				...
				<div class="col-md-3">   
					<div class="form-check" style="margin-top: 19pt;">
						<label class="form-check-label">
							<input class="form-check-input" type="checkbox"  name="PasscodeVerify"  id="PasscodeVerify"  value="Angular"> Passcode Verify
				...
				<!-- <div class="col-md-3">
					<div class="form-group bmd-form-group">
						...
						<input type="text" class="form-control" id="OrderQCSkipPercentage" name="OrderQCSkipPercentage" data-mask="(000)000-0000"/>
					</div>
				</div> -->
			</div>
			<div class="row mt-10">
			...
			<!-- <div class="col-sm-12 form-group pull-right">
				<p class="text-right">
					...
					<button type="button" class="btn btn-space btn-social btn-color btn-twitter adduser" value="1">SAVE USER</button>
				</p>
			</div> -->
			<div class="ml-auto text-right">
				<a href="User" class="btn btn-fill btn-back btn-wd ajaxload" role="button" aria-pressed="true"><i class="icon-arrow-left15 pr-10 Back"></i> Back</a>
				<button type="submit" class="btn btn-fill btn-save btn-wd adduser" name="adduser"><i class="icon-floppy-disk pr-10"></i>Save User</button>
			</div>
		...
		$(document).off('click','.adduser').on('click','.adduser', function(e) {
			...
			$.ajax({
				...
				success: function (response) {
					...
					// else if (response.loginid == "The loginid field must contain a unique value."){
						//   $(".loginidunique").show();
