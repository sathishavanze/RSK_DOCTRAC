  ...
  <div class="card mt-40" id="Orderentrycard">
    <div class="card-header card-header-danger card-header-icon">
      <div class="card-icon"> Add Company
      </div>
    </div>
    <div class="card-body">
      ...
      <div class="col-md-12">
       <div class="ml-auto text-right">
        ...
        <button type="submit" class="btn btn-fill btn-update btn-wd addCompany" name="addCompany"><i class="icon-floppy-disk pr-10"></i> Add Company </button>
      </div>
    </div>
  </form>
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document).off('click','.addCompany').on('click','.addCompany', function(e) {      
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('HoiCompanies/SaveCompany'); ?>",
        data: formdata,
        dataType:'json',
        beforeSend: function () {
