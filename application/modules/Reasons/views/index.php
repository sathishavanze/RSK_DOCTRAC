  ...
  <div class="card-header card-header-danger card-header-icon">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-right">
             <a href="<?php echo base_url('Reasons/AddReasons'); ?>"  class="btn btn-fill  btn-success btn-wd ajaxload cardaddinfobtn" ><i class="icon-user-plus pr-10"></i>Add Reasons</a>
    ...
    <div class="material-datatables">
      <table id="MaritalTableList" style="border:1px solid #ddd; white-space:nowrap;width: 100%;" class="table table-striped table-hover order-column">
               <thead>
                <tr>
                 <th  class="text-left">Reasons Name</th>
             ...
             <tbody>
              <?php
               $i=1;foreach($ReasonsDetails as $row): ?>
              <tr>
                   <td style="text-align: left;"><?php echo $row->ReasonName; ?></td>
                   <td style="text-align: left;"><?php echo $row->QueueName; ?> (<?php echo $row->WorkflowModuleName; ?>)</td>
                  ...
                  <td style="text-align: left"> 
                    <span style="text-align: left;width:100%;">
                      <a href="<?php echo base_url('Reasons/EditReasons/'.$row->ReasonUID);?>" class="btn btn-link btn-info btn-just-icon btn-xs ajaxload"><i class="icon-pencil"></i></a> 
                    </span>
                  </td>
              </tr>
            <?php 
