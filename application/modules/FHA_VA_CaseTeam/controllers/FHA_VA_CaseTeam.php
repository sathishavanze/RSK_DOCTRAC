...
class FHA_VA_CaseTeam extends MY_Controller {

	function __construct()
	{
		parent::__construct();
		$this->load->model('FHA_VA_CaseTeam_model');
	...
	public function index()
	{
		...
		$data['DocumentTypeNameDetails'] = $this->Common_Model->getfhacategorylist($OrderUID,$this->WorkflowModuleUID,$groups);
