					...
					<form action="#"  name="orderform" id="frmordersummary">
						...
						<?php $this->load->view('Ordersummary/Orderdetails'); ?>
							...
							<tbody class="addChecklist">
								...
								echo '<tr style = "background: #e6e0e0"><td style="font-size: 14px;font-weight: 400;padding: 9px 10px !important;" colspan="5">'.$Groups.' CHECKLIST</td> </tr>';
								 $question_sno =0; foreach ($DocumentTypeNameDetails as $key => $DocTypeName) {  $question_sno += 1; 
									if($DocTypeName->Groups == $Groups)
										{

										}
										else
										{
											$Groups = $DocTypeName->Groups;
											?>
											
											<tr style="background: #e6e0e0; padding: "><td style="font-size: 14px;font-weight: 400;padding: 9px 10px !important;" colspan="5"><?php echo $Groups ?> CHECKLIST </td> </tr>
