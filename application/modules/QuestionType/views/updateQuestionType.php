...
<div class="card mt-40" id="Orderentrycard">
	...
	<div class="card-body">
				...
				<form action="#"  name="user_form" id="user_form">
					<input type="hidden" class="form-control" id="QuestionTypeuid" name="QuestionTypeUID" value="<?php echo $UserDetails->QuestionTypeUID;?>" />
					<div class="row">
						<div class="col-md-3">
							<div class="form-group bmd-form-group">
								<label for="username" class="bmd-label-floating">Audit Check List Type <span class="mandatory"></span></label>
								<input type="text" class="form-control" id="QuestionTypeName" name="QuestionTypeName" value="<?php echo $UserDetails->QuestionTypeName;?>" />
							</div>
						</div>
					<!-- </div>
          <div class="row"> -->
          <div class="col-md-3"  style="margin-top: 19pt;">
    ...
    <label class="form-check-label"> Active
      ...
      <span class="toggle"></span>
					...
					<!-- <div class="col-sm-12 form-group pull-right">
						<p class="text-right">
							<button type="button" class="btn btn-space btn-social btn-color btn-twitter addQuestionType" value="1">Update QuestionType</button>
						</p>
					</div> -->
          ...
          <button type="submit" class="btn btn-fill btn-update btn-wd addQuestionType" name="addQuestionType"><i class="icon-floppy-disk pr-10"></i>Update Audit Check List Type </button>
          </div>
...
<script type="text/javascript">
   ...
   $(document).off('click','.addQuestionType').on('click','.addQuestionType', function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('QuestionType/UpdateQuestionType'); ?>",
      data: formdata,
      dataType:'json',
      beforeSend: function () {
