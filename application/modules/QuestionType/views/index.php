...
<div class="card mt-40 customcardbody" id="Orderentrycard">
	<div class="card-header card-header-danger card-header-icon">
      ...
      <div class="col-md-6 text-right">
          <a href="<?php echo base_url('QuestionType/AddQuestionType'); ?>"  class="btn btn-fill  btn-success btn-wd ajaxload cardaddinfobtn" ><i class="icon-grid3"></i> Add Audit Check List Type</a>
    ...
    <div class="material-datatables">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td style="text-align: left;"><?php echo $row->QuestionTypeName; ?></td>
      ...
      <td style="text-align: left"> 
        <span style="text-align: left;width:100%;">
          <a href="<?php echo base_url('QuestionType/EditQuestionType/'.$row->QuestionTypeUID);?>" class="btn btn-link btn-info btn-just-icon btn-xs ajaxload"><i class="icon-pencil"></i></a> 
        </span>
      </td>
    </tr>
    <?php 
