...
<div class="card  customcardbody mt-20" id="Orderentrycard">
	<div class="card-header card-header-danger card-header-icon">
		<div class="card-icon">Groups List
		</div>
		<div class="row">
			<div class="col-md-6">
			</div>
			<div class="col-md-6 text-right">
				<a href="<?php echo base_url(); ?>/Groups/add_group" class="btn btn-fill  btn-success btn-wd ajaxload cardaddinfobtn ajaxload"><i class="pr-10 icon-plus22"></i> Add Group</a>
			</div>
		</div>
	</div>
	...
	<div class="card-body">
		<div class="col-md-12">
			<div class="material-datatables">
				<table id="GroupTableList"  style="border:1px solid #ddd; white-space:nowrap;width: 100%;" class="table table-striped  table-hover order-column" >
					<thead>
						<tr>
...
<script type="text/javascript">
	...
	{
		var table = $('#GroupTableList').DataTable( {
			scrollX:        true,
			scrollCollapse: true,
			scrollY: '100vh',
			fixedHeader: false,
			...
			"ajax": {
				"url": "<?php echo base_url(); ?>Groups/Group_ajax_list",
				"type": "POST",
				"beforeSend": function() {
