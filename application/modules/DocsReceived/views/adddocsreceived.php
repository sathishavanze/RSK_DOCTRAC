...
<div class="card mt-40" id="Orderentrycard">
	...
	<div class="card-body">
				...
				<form action="#"  name="template_form" id="template_form">
					<input type="hidden" class="form-control" id="DocumentUID" name="DocumentUID" value="" />
          <input type="hidden" class="form-control" id="EmailUID" name="EmailUID" value="" />
         <div class="row">
          <div class="col-md-6">
            <div class="form-group bmd-form-group">
              <label for="RecipientEmail" class="bmd-label-floating"> Recipient Email </label>
              <input type="text" class="form-control" id="RecipientEmail"  value="" name="RecipientEmail" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group bmd-form-group">
              ...
              <input type="text" class="form-control" id="Subject"  value="" name="EmailSubject" required>
      ...
      <div class="row">
         <div class="col-md-6">
          <div class="form-group bmd-form-group">
           ...
           <textarea id="Body" name="EmailBody"></textarea>
        </div> 
      </div>
  </div>
    <div class="row">
