   ...
   <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?php echo base_url(); ?>assets/img/bookstore-bg.jpg'); background-size: cover; background-position: top center;">
      <div class="container">
         <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
            <form class="form" id="otp">
               <div class="card card-login card-hidden">
                  <div class="card-header card-header-default text-center">
                     <h4 class="card-title">Enter your Passcode</h4>
                     <div class="social-line">
                     </div>
                  </div>
                  <input type="hidden" name="userid" id="user" value="<?php echo $this->session->userdata('Temp_UserUID');?>">
                  <div class="card-body ">
                    <div class="form-group">
                      <label for="loginid" class="bmd-label-floating">Passcode</label>
                  ...
                  <div class="card-footer justify-content-center">
                     <div class="text-center" style="display: block;margin-bottom:20px">
                        <button type="submit" class="btn btn-tumblr btn-round mt-10 ForgetPassword" >check</button>
                     </div>
                  </div>
               </div>
            </form>
  ...
  $(document).ready(function() {
    ...
    setTimeout(function() {
       ...
       $.ajax({
          ...
          {
            // console.log(data);
            if(data.validation_error == 2 || data.validation_error == 1)
            {
              $.notify(
              {
            ...
            else
            {
                ...
                setTimeout ("window.location.href='<?php echo base_url('Dashboard');?>'", 3500);
            }
          },
