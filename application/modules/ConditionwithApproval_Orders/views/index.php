...
<div class="card mt-10">
	<div class="card-header card-header-danger card-header-icon">
		<div class="card-icon">
			<h4 class="card-title">Condition with Approval Orders</h4>
		</div>
		...
		<ul class="nav nav-pills nav-pills-rose customtab" role="tablist">
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#orderslist" role="tablist">
					New Orders
					<span class="badge badge-pill badge-primary newordercount" id="newdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->count_all(); ?></span>
			...
			if (in_array($this->RoleType, $this->config->item('Internal Roles'))) {
				...
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#workinprogresslist" role="tablist">
						Assigned Orders
						<span class="badge badge-pill badge-primary assignordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->inprogress_count_all(); ?></span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#myorderslist" role="tablist">
						My Orders
						<span class="badge badge-pill badge-primary myordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->myorders_count_all(); ?></span>
					</a>
				</li>
				...
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#parkingorderslist" role="tablist">
						Parking Orders
						<span class="badge badge-pill badge-primary parkordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->parkingorders_count_all(); ?></span>
					</a>
				</li>				
			<?php } ?> 
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#KickBacklist" role="tablist">
					KickBack Orders
					<span class="badge badge-pill badge-primary kickbackorder" id="newdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->KickBackcount_all(); ?></span>
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#Expiredorderslist" role="tablist">
					Expiry Orders
					<span class="badge badge-pill badge-primary Expiredorder" id="newdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->ConditionwithApproval_Orders_Model->Expiredcount_all(); ?></span>
