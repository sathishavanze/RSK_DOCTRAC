...
<div class="card mt-40">
	<div class="card-header card-header-danger card-header-icon">
		...
		<div class="row">
			<div class="col-md-10">
				<h4 class="card-title">CD-Orders</h4>
			</div>
		</div>
		...
		<ul class="nav nav-pills nav-pills-rose customtab" role="tablist">
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#orderslist" role="tablist">
					New Orders
					<span class="badge badge-pill badge-primary newordercount" id="" style="background-color: #fff;color: #000;"><?php echo $this->CD_Orders_Model->count_all(); ?></span>
			...
			if (in_array($this->RoleType, $this->config->item('Internal Roles'))) {
				...
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#workinprogresslist" role="tablist">
						Assigned Orders
						<span class="badge badge-pill badge-primary assignordercount" id="" style="background-color: #fff;color: #000;"><?php echo $this->CD_Orders_Model->inprogress_count_all(); ?></span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#myorderslist" role="tablist">
						My Orders
						<span class="badge badge-pill badge-primary myordercount" id="" style="background-color: #fff;color: #000;"><?php echo $this->CD_Orders_Model->myorders_count_all(); ?></span>
					</a>
				</li>
				...
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#parkingorderslist" role="tablist">
						Parking Orders
						<span class="badge badge-pill badge-primary parkordercount" id="" style="background-color: #fff;color: #000;"><?php echo $this->CD_Orders_Model->parkingorders_count_all(); ?></span>
					</a>
				</li>
