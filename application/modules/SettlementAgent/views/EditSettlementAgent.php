...
<div class="card mt-40 customcardbody" id="Orderentrycard">
  ...
  <div class="card-body pd-10">
   ...
   <input type="hidden" class="form-control" id="SettlementAgentUID" name="SettlementAgentUID" value="<?php echo $DocumentDetails->SettlementAgentUID;?>" />
       ...
       <div class="row mt-10">
        <div class="col-md-3">
         <div class="form-group bmd-form-group">
          ...
          <input type="text" class="form-control" id="SettlementAgentNo" name="SettlementAgentNo" value="<?php echo  $DocumentDetails->SettlementAgentNo; ?>"/>
        </div>
      </div>
      <div class="col-md-3">
       <div class="form-group bmd-form-group">
        <label for="SettlementAgentName" class="bmd-label-floating">Settlement Agent Name <span class="mandatory"></span></label>
        <input type="text" class="form-control" id="SettlementAgentName" name="SettlementAgentName"  value="<?php echo  $DocumentDetails->SettlementAgentName; ?>"  />
      </div>
    </div>
    <div class="col-md-3">
     <div class="form-group bmd-form-group">
      <label for="SettlementAgentPhone" class="bmd-label-floating">Settlement Agent Phone</label>
      <input type="text" class="form-control" id="SettlementAgentPhone" name="SettlementAgentPhone"  value="<?php echo  $DocumentDetails->SettlementAgentPhone; ?>" />
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group bmd-form-group">
      <label for="SettlementAgentFax" class="bmd-label-floating">Settlement Agent Fax</label>
      <input type="text" class="form-control" id="SettlementAgentFax" name="SettlementAgentFax"   value="<?php echo  $DocumentDetails->SettlementAgentFax; ?>"/>
    </div>
  </div>  
</div>
<div class="row mt-10">  
 <div class="col-md-3">
  <div class="form-group bmd-form-group">
    ...
    <input type="text" class="form-control" id="SettlementAgentEmail" name="SettlementAgentEmail" value="<?php echo  $DocumentDetails->SettlementAgentEmail; ?>"/>
  </div>
</div>
<div class="col-md-3">
  <div class="form-group bmd-form-group">
...
<div class="row mt-10">
  <div class="col-md-3">
    <div class="form-group bmd-form-group">
      ...
      <select class="select2picker form-control"  id="CityName" name="CityName" value="<?php echo $DocumentDetails->CityName;?>" >  
       <?php $cities=$this->db->get_where('mCities',   array('CityUID' => $DocumentDetails->CityName))->row(); ?>
...
<div class="col-md-3 ">
  <div class="form-group bmd-form-group">
    ...
    <select class="select2picker form-control"  id="StateName" name="StateName" value="<?php echo $DocumentDetails->StateName;?>" >
     <?php 
     $States=$this->db->get_where('mStates',   array('StateUID' => $DocumentDetails->StateName))->row(); 
     if (!empty($States)) {
      ?>
...
<div class="ml-auto text-right">  
 ...
 <button type="submit" class="btn btn-fill btn-save btn-wd adduser" name="adduser"><i class="icon-floppy-disk pr-10"></i>Update Settlement Agent</button>
</div>
</div>
</form>
</div>
...
<script type="text/javascript">
   ...
   $(document).off('click','.adduser').on('click','.adduser', function(e) {
     ...
     $.ajax({
      type: "POST",
      url: "<?php echo base_url('SettlementAgent/UpdateSettlement'); ?>",
      data: formdata,
      dataType:'json',
      beforeSend: function () {
