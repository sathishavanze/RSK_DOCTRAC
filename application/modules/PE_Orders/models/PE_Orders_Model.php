...
class PE_Orders_Model extends MY_Model {
	...
	{ 
		...
		$this->WorkflowModuleUID = $this->config->item('Workflows')['PE'];     
	}
	...
	function total_count()
	{
		...
		/*^^^^^ Get MyOrders Query ^^^^^*/
		$this->Common_Model->GetPEOrders(false);
  ...
  // MyOrders
	...
	function PEOrders($post,$module,$global=''){
