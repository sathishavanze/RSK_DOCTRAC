...
<div class="card mt-40" id="Orderentrycard">
	...
	<div class="card-body">
				...
				<form action="#"  name="user_form" id="user_form">
					<input type="hidden" class="form-control" id="Milestoneuid" name="MilestoneUID" value="<?php echo $UserDetails->MilestoneUID;?>" />
					<div class="row">
						<div class="col-md-3">
							<div class="form-group bmd-form-group">
								<label for="username" class="bmd-label-floating">MilestoneName <span class="mandatory"></span></label>
								<input type="text" class="form-control" id="MilestoneName" name="MilestoneName" value="<?php echo $UserDetails->MilestoneName;?>" />
							</div>
						</div>
         ...
         <div class="col-sm-12 form-group pull-right">
          ...
          <button type="submit" class="btn btn-fill btn-update btn-wd updatemilestone" name="updatemilestone"><i class="icon-floppy-disk pr-10"></i>Update Milestone</button>
          </div>
...
*/
   ...
   $(document).off('click','.updatemilestone').on('click','.updatemilestone', function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('Milestone/UpdateMilestone'); ?>",
      data: formdata,
      dataType:'json',
      beforeSend: function () {
