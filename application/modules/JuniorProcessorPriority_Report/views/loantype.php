			...
			<table class="table table-hover" id="priority-data" style="">
				<thead>
					<tr>
						...
						<th class="text-center no-sort"><b>Processor</b></th>
				...
				<tbody id="OrderAge_Count">
					...
					<?php foreach ($LoanTypes as $LoanTypeKey => $LoanType) { ?>
						...
						<tr class="text-center">
							...
							<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo 'Pending'. $LoanTypeKey; ?>"  data-orderid=""  title="<?php echo 'Total Pipeline ( '.$LoanType.')'; ?>" data-workflowmoduleuid="">0</a></td>
							<?php foreach ($Customer_Prioritys as $Priority) { ?>
								<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $LoanTypeKey.'Priority'.$Priority->PriorityUID; ?>"  data-orderid=""  title="<?php echo $LoanType.' ( '.$Priority->PriorityName.')'; ?>" data-workflowmoduleuid="<?php echo $Priority->WorkflowModuleUID; ?>">0</a></td>
							<?php } ?>
							<td class="text-center bold"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $LoanTypeKey.'Total'; ?>"  data-orderid=""  title="<?php echo $LoanType.' (Total)'; ?>" data-workflowmoduleuid="">0</a></td>
