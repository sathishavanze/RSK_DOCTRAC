...
<div class="card" id="orderstablediv" style="display: none;">
			...
			<div class="row"> 
				<div class="col-md-12 pd-0">
					<div class="material-datatables">
						...
						?>
						<table id="orderslist" class="table table-striped table-no-bordered table-hover wraptable datepickertable" cellspacing="0" width="100%"  style="width:100%;margin:0;">
							<thead>
								<tr>
									...
									{ 
										$sort = ($queue->NoSort == 1 && empty($queue->SortColumnName)) ? 'class="no-sort"' : '';
	...
	<script src="assets/js/app/juniorprocessorpriorityreport.js?reload=1.0"></script>
