			...
			<table class="table table-hover" id="priority-data" style="">
				<thead>
					<tr>
						...
						<th class="text-center"><b>Processor</b></th>
				...
				<tbody id="OrderAge_Count">
					...
					<?php foreach ($Processors as $ProcessorKey => $Processor) { ?>
						...
						<tr class="text-center">
							...
							<?php foreach ($Customer_Prioritys as $Priority) { ?>
								<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $Processor->UserUID.'Priority'.$Priority->PriorityUID; ?>"  data-orderid=""  title="<?php echo $Processor->UserName.' ( '.$Priority->PriorityName.')'; ?>" data-workflowmoduleuid="">0</a></td>
							<?php } ?>
					...
					<tr class="text-center">
						...
						<?php foreach ($Customer_Prioritys as $Priority) { ?>
							<td class="text-center bold"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo 'Priority'.$Priority->PriorityUID.'Total'; ?>"  data-orderid=""  title="<?php echo $Priority->PriorityName .' (Total)'; ?>" data-workflowmoduleuid="">0</a></td>
						<?php } ?>
