...
<div class="card mt-40" id="Orderentrycard">
	...
	<div class="card-body">
		<ul class="nav nav-pills nav-pills-danger customtab entrytab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link active ajaxload bulkAssign" href="<?php echo base_url(); ?>Orderentry/PayOffUpdate" role="tablist">
					PayOff 
				</a>
			</li>
			<li class="nav-item">
...
<script type="text/javascript">
    ...
    $(document).off('change', '#bulk_products').on('change', '#bulk_products', function (e) {
    	...
    	var Entrytype = $(this).find(':selected').attr('data-payoffbulkupdateformat');
    	var Entrytypefile = $(this).find(':selected').attr('data-payoffbulkupdatetemplatename');
    ...
    $(document).off('click', '.changeentryfilename').on('click', '.changeentryfilename', function (e) {
      ...
      error: function(jqXHR, textStatus, errorThrown) {
		...
		$(document).off('click',  '#preview').on('click',  '#preview', function (event) {
			...
			/*for update type*/
			url="Orderentry/preview_PayOffBulkUpdate";
		...
		$(document).off('click',  '#bulk_save').on('click',  '#bulk_save', function (event) {
			...
			/*for update type*/
			url = 'Orderentry/UpdateBulkPayOff';
