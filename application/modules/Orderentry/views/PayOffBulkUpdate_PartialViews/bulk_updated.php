...
<div class="tab-content tab-space">
	...
	<div id="error-data" class="tab-pane cont">
		...
		<div class="">
			...
			<span class="badge badge-pill pull-right" style="background-color: #ff9800;">Invalid Site</span>
			<span class="badge badge-pill pull-right" style="background-color: #9575cd;">Invalid Last Payment Received Date</span>
...
<script type="text/javascript">
	...
	function UpdateSuccessExcel() {		
		...
		$.ajax({
			...
			{
				var filename = "BulkPayOffUpdatePreview.xlsx";
				if (typeof window.chrome !== 'undefined') {
					//Chrome version
					var link = document.createElement('a');
					link.href = window.URL.createObjectURL(data);
					link.download = "PayOffBulkUpdate_Success.xlsx";
					link.click();
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				if (typeof window.chrome !== 'undefined') {
					...
					var link = document.createElement('a');
					link.href = window.URL.createObjectURL(data);
					link.download = "PayOffBulkUpdate_Failed.xlsx";
					link.click();
				} else if (typeof window.navigator.msSaveBlob !== 'undefined') {
					//IE version
					var blob = new Blob([data], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
