					...
					<form action="#"  name="orderform" id="frmordersummary">
						...
						<?php $this->load->view('Ordersummary/Orderdetails'); ?>
							...
							<tbody class="addChecklist">
								...
								$data1['WorkflowUID'] = $this->config->item('Workflows')['ThirdPartyTeam'];
								$this->load->view('checklist/otherchecklist',$data1);?>
							</tbody>	
						</table>
						<p class="custom_add_icon pull-right addchecklistrow" data-count = '1'  data-moduleUID = '<?php echo $this->config->item('Workflows')['ThirdPartyTeam']; ?>' style="margin-right:10px;" aria-hidden="true">Add New Checklist</p>
						...
						<div class="row ">
							<div class="col-md-3">
								<div class="form-group bmd-form-group">
									<label for="HOV" class="bmd-label-floating">HOI</label>
									<input type="text" class="form-control" id="HOI" name="HOI"  value="<?php echo $OrderDetails->HOI; ?>"  aria-haspopup="true" aria-expanded="false">
									<ul class="dropdown-menu dropdown-style HOI"></ul>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group bmd-form-group">
									<label for="Payoff" class="bmd-label-floating">Payoff</label>
									<input type="text" class="form-control" id="Payoff" name="Payoff"  value="<?php echo $OrderDetails->Payoff; ?>"  aria-haspopup="true" aria-expanded="false" >
									<ul class="dropdown-menu dropdown-style Payoff"></ul>
								</div>
							</div>
						</div>
						<div>
							...
							$data2['WorkflowModuleUID'] = $this->config->item('Workflows')['ThirdPartyTeam'];
