             ...
             <!-- user name filter with multi selecet -->
              ...
              <div style="width: 20%" class="padding workflow">
                <div class="form-group bmd-form-group">
                  ...
                  <select class="form-control mdb-select" id="adv_workflow"  name="workflow" multiple="true" placeholder="Select Workflow(s)">   
                      <option value=""></option>
...
<script type="text/javascript">
  ...
  function ActivityReport(formData)
  { 	
  	$.ajax({
  		type: "POST",
  		url: '<?php echo base_url();?>ActivityReport/getActiveLogs',
  		data: formData,
  		dataType: 'JSON',
  		beforeSend: function()
  		{
  ...
  {      
    ...
    else
    {
      $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>ActivityReport/getFromToDate',
        data: {'period':period},
        dataType: 'JSON',
        success: function(data)
        {
