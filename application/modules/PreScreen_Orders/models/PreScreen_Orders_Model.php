...
class PreScreen_Orders_Model extends MY_Model {
	...
	function total_count()
	{
		...
		/*^^^^^ Get MyOrders Query ^^^^^*/
		$this->Common_Model->GetPreScreenOrders(false);
  ...
  // New Orders
	...
	function PreScreenOrders($post,$module,$global='')
	{
		$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
  ...
  // Work in Progress
	...
	function KickBackPreScreenOrders($post,$module,$global='')
	{
		$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
	...
	function Expiredcount_all($post=[])
	{
		...
		/*^^^^^ Get Prescreen Query ^^^^^*/
		$this->Common_Model->GetPreScreenOrders(false,['filtercompletedorders'=>true]);
...
function ExpiredPreScreenOrders($post,$module,$global='')
	{
		$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
