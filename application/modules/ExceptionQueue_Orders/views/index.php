...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document).off('click','.filterreport').on('click','.filterreport',function()
    {
              ...
              if((ProjectUID == '')  && (WorkflowModuleUID == '') && (CustomerUID == '') && (Status == '')&& (FromDate == '')&& (ToDate == ''))
              {
              ...
              {
               var formData = ({'WorkflowModuleUID':WorkflowModuleUID,'ProjectUID': ProjectUID ,'CustomerUID':CustomerUID,'Status':Status,'FromDate':FromDate,'ToDate':ToDate}); 
