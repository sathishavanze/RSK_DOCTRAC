		...
		<div class="card-body pd-0">
			...
			<div class="tab-content tab-space">
				<div class="tab-pane active" id="summary">
							<!-- Load Calculator  -->
							<?php $this->load->view('Calculator/calculator'); ?>
							<!-- Load Calculator  -->
					<form action="#"  name="orderform" id="frmordersummary">
						...
						<div class="col-sm-12 form-group pull-right mt-20">
							<p class="text-right">
								...
								<?php }?>
								<?php 
								// Check is order in kickback and rework queue hide workflow buttons
								if ($this->Common_Model->CheckIsKickBackOrder($OrderSummary->OrderUID, $WorkflowModuleUID) == 0) {
									$this->load->view('orderinfoheader/workflowbuttons');
								}
								?>
