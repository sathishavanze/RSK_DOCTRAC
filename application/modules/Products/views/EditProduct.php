...
<div class="card mt-40" id="Orderentrycard">
   ...
   <form action="#"  name="Product_form" id="Product_form">
     <input type="hidden" class="form-control" id="ProductUID" name="ProductUID" value="<?php echo $ProductDetails->ProductUID;?>" />
     <div class="row">

      <div class="col-md-4">
        <div class="form-group bmd-form-group">
          <label for="ProductName" class="bmd-label-floating">Product Code <span class="mandatory"></span></label>
          <input type="text" class="form-control" id="ProductCode"  value="<?php echo $ProductDetails->ProductCode;?>" name="ProductCode" />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group bmd-form-group">
          ...
          <input type="text" class="form-control" id="ProductName"  value="<?php echo $ProductDetails->ProductName;?>" name="ProductName" />
        </div>
      </div>
		...
		<div class="col-md-4" style="margin-top: 20px; margin-left: 15px;"> 
              <div class="form-check">
                <label class="form-check-label Dashboardlable" for="OcrEnable">
                  <input class="form-check-input" id="OcrEnable" type="checkbox" value="" name="OcrEnable" <?php if($ProductDetails->IsOCREnabled == 1) { echo "checked"; } ?>> 
                  Is OCR
    ...
    <div class="row">
          ...
          <label for="productdoctype" class="bmd-label-floating">Product Doc Types<span class="mandatory"></label>
            <select class="select2picker form-control"  id="productdoctype" name="productdoctype[]" multiple>
              ...
              <?php foreach ($InputDocTypes as $key => $value) { ?>
                ...
                <?php if (in_array($value->InputDocTypeUID, $SelectedDocTypes)) { ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group bmd-form-group">
            ...
            <select class="select2picker form-control"  id="ddlRules">
              <option></option>
        ...
        <div class="col-md-12 mt-10">
          <table class="table table-bordered" id="tblProductRules">
            <thead>
              <tr>
                <th style="width: 5%; padding: 3px 3px !important;" class="text-center">SNo</th>
                <th style="padding: 3px 3px !important;" class="text-center">Rule</th>
                <th style="padding: 3px 3px !important;" class="text-center">Action</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($ProductRules as $key => $rule) { ?>
                <tr>
                  <input type="hidden" name="Rules[]" value="<?php echo $rule->RuleUID; ?>">
                  <td style="width: 5%;" class="text-center"><?php echo $key + 1; ?></td>
                  <td class="text-left"><?php echo $rule->RuleName; ?></td>
                  <td class="text-center"><button data-ruleuid = "<?php echo $rule->RuleUID; ?>" data-rulename = "<?php echo $rule->RuleName; ?>" class="btn btn-pinterest removerules"><i class="fa fa-trash" aria-hidden="true"></i></button> </td>
                </tr>
                <?php
              }
              ?>
        ...
        <div class="col-md-4" >
          <div class="togglebutton">
            <label class="label-color"> Active:  
              <input type="checkbox" id="Active" name="Active" class="Active" <?php if($ProductDetails->Active == 1){ echo "checked"; } ?>>
      ...
      <div class="col-md-12">
       <div class="ml-auto text-right">
        ...
        <button type="submit" class="btn btn-fill btn-update btn-wd btn-editProduct" name="btn-editProduct"><i class="icon-floppy-disk pr-10"></i>Update Product </button>
      </div>
    </div>
