			...
			<table class="table table-hover" id="priority-data" style="">
				<thead>
					<tr>
						...
						<th class="text-center no-sort"><b>Milestone</b></th>
				...
				<tbody id="OrderAge_Count">
					...
					<?php foreach ($Milestones as $Milestonekey => $MilestoneName) { ?>
						<tr class="text-center">
							<td><?php echo $MilestoneName; ?></td>
							<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $Milestonekey.'totalpipeline'; ?>"  data-orderid=""  title="<?php echo $MilestoneName.' ( Total Pipeline)'; ?>" data-workflowmoduleuid="">0</a></td>
							<?php foreach ($Workflows as $Workflow) { ?>
								<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $Milestonekey.$Workflow->SystemName; ?>"  data-orderid=""  title="<?php echo $MilestoneName.' ( '.$Workflow->WorkflowModuleName.')'; ?>" data-workflowmoduleuid="<?php echo $Workflow->WorkflowModuleUID; ?>">0</a></td>
							<?php } ?>
