				...
				<tbody id="OrderAge_Count">
					<?php foreach ($AgingHeader as $AgingHeaderkey => $Header) { ?>
						<tr class="text-center">
							...
							<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $AgingHeaderkey.'totalpipeline'; ?>"  data-orderid=""  title="<?php echo $Header.' ( Total Pipeline)'; ?>" data-workflowmoduleuid="">0</a></td>
							<?php foreach ($Workflows as $Workflow) { ?>
								<td class="text-center"><a href="javascript:void(0);" class="text-primary listorders" data-count="<?php echo $AgingHeaderkey.$Workflow->SystemName; ?>"  data-orderid=""  title="<?php echo $Header.' ( '.$Workflow->WorkflowModuleName.')'; ?>" data-workflowmoduleuid="<?php echo $Workflow->WorkflowModuleUID; ?>">0</a></td>
							<?php } ?>
