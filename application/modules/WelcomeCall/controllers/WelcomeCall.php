...
class WelcomeCall extends MY_Controller {

	function __construct()
	{
		parent::__construct();
		$this->load->model('WelcomeCall_model');
	...
	public function index()
	{
		...
		$data['Callbacks'] = $this->WelcomeCall_model->get_parking_callbacks($OrderUID);
		...
		$data['tOrderMeeting'] = $this->Common_Model->get_row('tOrderMeeting', ['MeetingOrderUID'=>$OrderUID, 'WorkflowModuleUID'=>$this->WorkflowModuleUID]);
