...
<div class="card mt-40" id="Orderentrycard">
	...
	<div class="card-body">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group bmd-form-group">
								<label for="categoryname" class="bmd-label-floating">Category Name <span class="mandatory"></span></label>
          ...
          <button type="submit" class="btn btn-fill btn-save btn-wd addcategory" name="addcategory"><i class="icon-floppy-disk pr-10"></i>Add Category</button>
          </div>
          <!-- <div class="col-sm-12 form-group pull-right">
            <p class="text-right">
             <button type="button" class="btn btn-space btn-social btn-color btn-twitter addcategory" value="1">Save Category</button>
           </p>
         </div> -->
       </form>
...
<script type="text/javascript">
   ...
   $(document).off('click','.addcategory').on('click','.addcategory', function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('Category/SaveCategory'); ?>",
      data: formdata,
      dataType:'json',
      beforeSend: function () {
