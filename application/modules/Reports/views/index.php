...
<div class="card mt-40" >
    <div class="card-header card-header-danger card-header-icon">
      <div class="card-icon">Queues Report </div>
    </div>
<div class="card-body">
 <div class="col-md-12">
...
<div class="card-header card-header-icon card-header-rose">         
     ...
     <div class="col-md-12 pd-0 filters_div">
      ...
      <label for="WorkflowModule" class="bmd-label-floating">Please Select WorkflowModule</label>
      <select class="form-control select2picker"  id="WorkflowModule"  name="WorkflowModule" placeholder="">
...
<!--          <label for="mQueue" class="bmd-label-floating">Please Select Queue</label>
...
$('#WorkflowModule').change(function(event) {
        ...
        /* $.ajax({
              type: "POST",
              url: '<?php echo base_url();?>Reports/GetUsersByWorkflow',
              data: ({'WorkflowModule':WorkflowModule}),
              dataType: 'JSON',
              beforeSend: function()
              {
...
$(document).on('click','.submit',function()
  {
      ...
      if((mQueue != '0') && (WorkflowModule != '0') ){
         $.ajax({
              type: "POST",
              url: '<?php echo base_url();?>Reports/GetUsersByWorkflow',
              data: ({'WorkflowModule':WorkflowModule,'mQueue':mQueue,'UsrList':UserList}),
              dataType: 'JSON',
              beforeSend: function()
              {
                addcardspinner($('#Queues-div'));
