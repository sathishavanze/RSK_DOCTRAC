...
class FundingConditions_Orders_Model extends MY_Model {
	...
	function total_count()
	{
		...
		/*^^^^^ Get MyOrders Query ^^^^^*/
		$this->Common_Model->GetFundingConditionsOrders(false);
  ...
  // New Orders
	function count_all($post=[])
	{
		...
		/*^^^^^ Get FundingConditions Query ^^^^^*/
		$this->Common_Model->GetFundingConditionsOrders();
	...
	function FundingConditionsOrders($post,$module,$global='')
			{
				$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
  ...
  // Work in Progress
	...
	function KickBackcount_all($post=[])
	{
      ...
      // Datatable OrderBy
			...
			function KickBackFundingConditionsOrders($post,$module,$global='')
			{
				$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
