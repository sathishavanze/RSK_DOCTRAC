     ...
     <tbody>
       ...
       { 
        ...
        <tr>
          ...
          <td><a href="javascript:;" title="View Loans" data-heading="Queue Progress <?php echo $row["Date"]; ?> - Inflow" class="listorders" data-orderid="<?php echo $row['InflowOrders']; ?>"><?php echo $row["InflowCount"]; ?></a></td>
          <td><a href="javascript:;" title="View Loans" data-heading="Queue Progress <?php echo $row["Date"]; ?> - Completed" class="listorders" data-orderid="<?php echo $row['CompletedOrders']; ?>"><?php echo $row["CompleteCount"]; ?></a></td>
          <td><a href="javascript:;" title="View Loans" data-heading="Queue Progress <?php echo $row["Date"]; ?> - Pending" class="listorders" data-orderid="<?php echo $row['PendingOrders']; ?>"><?php echo $row["PendingCount"]; ?></a></td>
          <td><span><?php echo $ratio; ?>%</span></td>
        </tr>        
        <?php 
