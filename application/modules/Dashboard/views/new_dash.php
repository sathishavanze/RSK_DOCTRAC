            ...
            <div class="row ">
              <div class="col-md-3 ">
                <div class="form-group bmd-form-group">
                  ...
                  <select class="form-control" data-toggle="select2" id="adv_WorkflowModuleUID" name="adv_WorkflowModuleUID">
                            <option selected>Select</option>
                        <?php 
                        foreach ($WorkFlow as $row)
                        {
                            echo '<option value="'.$row->WorkflowModuleUID.'">'.$row->WorkflowModuleName.'</option>';
                        }
                        ?>
                    </select>
                </div>
              ...
              <div class="col-md-3 ">
                <div class="form-group bmd-form-group">
                  	...
                  	<select class="form-control" data-toggle="select2" id="adv_period" name="adv_period">
               ...
               <div class="col-md-3 ">
                <div class="form-group bmd-form-group">
                  ...
                  <div class="input-daterange input-group" id="date-range">
                            <input type="text" class="form-control" id="adv_fromDate" name="start" placeholder="From"/>
                            <input type="text" class="form-control" id="adv_toDate" name="end" placeholder="To"/>
                        </div>
                </div>
              </div>
	          <div class="col-md-3">
			...
			<div class="card mt-10" id="OrderStatistics_Card">
						...
						<div class="col-md-12 text-right">
							<div class="dropdown float-right" style="margin-left: 5px;">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="top: 67%!important;">
                                    <a class="dropdown-item" href="javascript:void(0)" selected>Team</a>
                                    <a class="dropdown-item" id="indPeriod" name="indPeriod" href="javascript:void(0)">Individual</a>
                                </div>
                            </div>
						</div>
					</div>
				...
				<div class="card-body pd-0 dd">
					...
					<div class="col-md-12">
						<div class="row">
                            <div class="col-xl-8">
                            <label for="" class="col-form-label" style="float: right;">Target </label></div>
                            <div class="mb-10">
                            <input type="text" class="form-control" id="adv_Target" name="adv_Target"></div>
                        </div>
                        <div class="col-md-12 TableInflow scrool">
...
function dashboard_refresh($object)
{
  ...
  {      
    ...
    else
    {
      $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>Dashboard/getFromToDate',
        data: {'period':period},
        dataType: 'JSON',
        success: function(data)
        {
    ...
    $.ajax({
        type: "POST",
        url: 'http://localhost/doctrac_theme/Dashboard/getProcessInflowTable',
        data: formData,
        dataType: 'JSON',
        beforeSend: function()
        {
  ...
  function getReportInflow(Period,FromDate,ToDate,WorkflowModuleUID,Target=10,Type='Team'){
   ...
   {
     var formData = ({'FromDate': FromDate ,'ToDate' : ToDate,'Target':Target,'WorkflowModuleUID':WorkflowModuleUID,'Type':Type});
...
var adv_toDate = $('#adv_toDate').val();
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url();?>Dashboard/bindReport',
...
//call inflow report details
getReportInflow(adv_period,adv_fromDate,adv_toDate,WorkFlows);
