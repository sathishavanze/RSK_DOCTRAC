...
<div class="card mt-10">
	<div class="card-header card-header-danger card-header-icon">
		<div class="card-icon">
			...
			<h4 class="card-title">WorkUp Orders</h4>
		</div>
...
<!-- 		<div class="row">
	...
	<div class="card-body" id="filter-bar">
		...
		<ul class="nav nav-pills nav-pills-rose customtab" role="tablist">
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#orderslist" role="tablist">
					New Orders
					<span class="badge badge-pill badge-primary newordercount" id="newdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->count_all(); ?></span>
			...
			<?php
				if (in_array($this->RoleType, $this->config->item('Internal Roles'))) {
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#workinprogresslist" role="tablist">
							Assigned Orders
							<span class="badge badge-pill badge-primary assignordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->inprogress_count_all(); ?></span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " data-toggle="tab" href="#myorderslist" role="tablist">
							My Orders
							<span class="badge badge-pill badge-primary myordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->myorders_count_all(); ?></span>
						</a>
					</li>
				...
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#parkingorderslist" role="tablist">
						Parking Orders
						<span class="badge badge-pill badge-primary parkordercount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->parkingorders_count_all(); ?></span>
					</a>
				</li>
			<?php } ?>
				...
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#KickBacklist" role="tablist">
						KickBack Orders
						<span class="badge badge-pill badge-primary kickbackorder" id="newdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->KickBackcount_all(); ?></span>
				...
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#WorkupRework_OrdersList" role="tablist">
						Rework 
						<span class="badge badge-pill badge-primary WorkupReworkCount" id="pendinguw-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->WorkupRework_CountAll(); ?></span>
					</a>
				</li>
			...
			<?php } ?>
				...
				<!-- CD section -->
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#CDInflowOrdersList" role="tablist">
						CD Inflow
						<span class="badge badge-pill badge-primary CDInflowOrdersCount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->CDInflowOrders_CountAll(); ?></span>
					</a>
				</li>
				
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#CDPendingOrdersList" role="tablist">
						CD Pending
						<span class="badge badge-pill badge-primary CDPendingOrdersCount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->WorkUp_Orders_Model->CDPendingOrders_CountAll(); ?></span>
					</a>
				</li>
				
				<li class="nav-item">
					<a class="nav-link " data-toggle="tab" href="#CDCompletedOrdersList" role="tablist">
						CD Completed
						<span class="badge badge-pill badge-primary CDCompletedOrdersCount" id="workinprogressdoc-checkin-count" style="background-color: #fff;color: #000;"><?php echo $this->Common_Model->completedordersBasedOnWorkflow_count_all(['WorkflowModuleUID' => $this->config->item('Workflows')['CD']]); ?></span>
					</a>
				</li>
				<!-- CD section End -->
		...
		<div class="tab-content tab-space customtabpane">
			...
			$viewdata['WorkupReworkTableName'] = "WorkupReworkOrdersTable";
			// CD section
			$viewdata['IsCDsection'] = true;
			$viewdata['CDInflowOrdersTableName'] = "CDInflowOrdersTable";
			$viewdata['CDPendingOrdersTableName'] = "CDPendingOrdersTable";
			$viewdata['CDCompletedOrdersTableName'] = "CDCompletedOrdersTable";
			// CD section End
			?>
