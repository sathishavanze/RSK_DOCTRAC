...
class SignedDocs_Orders_Model extends MY_Model {
	...
	function total_count()
	{
		...
		/*^^^^^ Get MyOrders Query ^^^^^*/
		$this->Common_Model->GetSignedDocsOrders(false);
  ...
  // New Orders
	function count_all($post=[])
	{
		...
		/*^^^^^ Get SignedDocs Query ^^^^^*/
		$this->Common_Model->GetSignedDocsOrders();
      ...
      // Datatable OrderBy
			...
			function SignedDocsOrders($post,$module,$global='')
			{
  ...
  // Work in Progress
	...
	function KickBackcount_all($post=[])
	{
      ...
      // Datatable OrderBy
			...
			function KickBackSignedDocsOrders($post,$module,$global='')
			{
				$this->Common_Model->DynamicColumnsCommonQuery($this->WorkflowModuleUID);
