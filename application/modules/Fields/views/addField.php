...
<div class="card mt-40" id="Orderentrycard">
  ...
  <div class="card-body">
        ...
        <form action="#"  name="field_form" id="field_form" method="POST">
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group bmd-form-group">
                ...
                <select class="select2picker form-control"  id="FieldType" name="FieldType">
                  ...
                  <option value="select2picker">Select 2 Picker</option>  -->                
                  <?php
...
<div class="row mt-10">
            <div class="col-md-2">
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="checkbox" name="IsStacking" id="IsStacking" value="Stacking"> Stacking
            ...
            <div class="col-md-2">
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="checkbox" name="IsIndexing" id="IsIndexing" value="Indexing"> Indexing
                  <span class="form-check-sign">
                    <span class="check"></span>
                  </span>
                </label>
        ...
        <div class="ml-auto text-right">
         ...
         <button type="submit" class="btn btn-fill btn-save btn-wd addfield" name="addfield"><i class="icon-floppy-disk pr-10"></i>Save Field</button>
       </div>
</form>
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document).off('click','.addfield').on('click','.addfield', function(e) {      
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('Fields/SaveField'); ?>",
        data: formdata,
        dataType:'json',
        beforeSend: function () {
